...
const mission4 = [
  ...
  { id: 38,
    question: '【自由落下】初速 0 の物体が t = 3 s 落下した。重力加速度 g = 9.8 m/s² のとき、速度 v は？（v = gt）',
    choices: ['19.6 m/s', '29.4 m/s', '30 m/s', '39.2 m/s'], answer: 1,
    explanation: '自由落下では v = gt\n初速 0 より v = gt\ng = 9.8, t = 3 → v = 9.8 × 3 = 29.4 m/s' },
  { id: 39,
